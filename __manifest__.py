...
* Advanced security features""",
    ...
    'data': [
        ...
        # Views with action definitions (load before menu_items.xml)
        ...
        # Menu items (load after views with action definitions)
        'views/menu_items.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'an_push_attendance/static/src/js/**/*',
            'an_push_attendance/static/src/css/**/*',
        ],
    },
